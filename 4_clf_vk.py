...
# Загрузите модель EfficientNet-B0 и настройте её для классификации на 11 классов
model = models.efficientnet_b4(pretrained=True)
num_classes = 10
model.classifier[1] = nn.Linear(model.classifier[1].in_features, num_classes)

# Загрузите сохранённые веса модели
model.load_state_dict(torch.load('efficientnet_b4_trained_model.pth', map_location=device))
...
folder_path = "downloaded_images_from_VK — копия"
